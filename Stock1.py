...
Product = options_form.selectbox(
        "Select the Product:", ('Amarula', 'Amstel Dumpies', 'Amstel Quarts', 'Amstel Raddler', 'Appletiser', 'Bacardi', 'Belgravia Blood Orange', 'Belgravia Gin & Dry Lemon', 'Belgravia Pink Gin Mix', 'Bells', 'Black Label Dumpies', 'Black Label Quarts', 'Cactus Jack', 'Cape to Rio Cane', 'Captain Morgan', 'Carribean Twist Pina Colada', 'Castle Dumpies', 'Castle Lite Dumpies', 'Castle Lite Quarts', 'Castle Milk Stout Quarts', 'Castle Quarts', 'Coke', 'Coke Light', 'Coke Zero', 'Cookies & Cream', 'Creme Soda', 'Drostdy Hoff Extra Light White 5L', 'Dry Lemon', 'Famous Grouse', 'Fanta Orange', 'Flying Fish Lemon Dumpies', 'Fruittree Mediteranean', 'Fruittree Orange', 'Ginger Ale', 'Glen Grant', 'Gordons Gin', 'Graca', 'Hansa Dumpies', 'Hansa Quarts', 'Harrier', 'Hunters Dry Dumpies', 'Hunters Dry Quarts', 'Hunters Gold Dumpies', 'J&B', 'Jack Daniels', 'Jaegermeister', 'Jameson', 'Johnny Walker Red', 'Kahlua', 'Klipdrift', 'Klipdrift Premium', 'Label5', 'Lemonade', 'Lion Quarts', 'Malibu', 'Olaf Bergh', 'Old Brown Sherry', 'Peppermint Liquer', 'Pimms', 'PO10c', 'Ponchos', 'Porcupine Ridge Sauv Blanc', 'Powerade Jagged Ice', 'Powerade Mountain Blast', 'Powerade Naartjie', 'Pushkin Apple', 'Red Heart', 'Red Square Energiser', 'Redbull', 'Richlieu', 'Robertsons Dry Red 500ml', 'Robertsons Dry White 500ml', 'Savanah Dry', 'Savanah Light', 'Scottish Leader', 'Smirnoff Vodka', 'Soda Water', 'Southern Comfort', 'Sparberry', 'Spiced Gold', 'Sprite', 'Sprite Zero', 'Stoney Ginger', 'Strawberry Lips', 'Sunkissed Rose', 'Tall Horse Merlot', 'Tequila Gold Olmeca', 'Tequila Silver Olmeca', 'Tomato Cocktail', 'Tonic', 'Valpre Sparkling Water', 'Valpre Still Water', 'Vat69', 'Windhoek Draught Dumpies', 'Windhoek Draught Quarts', 'Windhoek Lager Quarts'))
